...
class MUDataAgent(SignAgent):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--remove-subword", type=int, default=5,
                            help="Number of tokens for tail truncation")
        parser.add_argument("--output-file", type=str, required=True,
                            help="Path of mu data")
    ...
    def policy(self, states):
        ...
        # translation before tail truncation
        ...
        # translation after tail truncation
