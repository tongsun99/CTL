...
from .g2t import TransformerMixupEncoder
from torch import Tensor
logger = logging.getLogger(__name__)

@register_model("sign2text_concat")
class S2TConcatModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        S2TConcatModel.add_specific_args(parser)
    ...
    def build_encoder(cls, args, task=None, embed_tokens=None):
        encoder = S2TConcatEncoder(args, task, embed_tokens)
...
class S2TConcatEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths,gloss_src_tokens, gloss_src_lengths,**kwargs):
        ...
        sign_encoder_out["encoder_padding_mask"] = [gloss_encoder_padding_mask]
...
@register_model_architecture(model_name="sign2text_concat", arch_name="sign2text_concat")
...
@register_model_architecture("sign2text_concat", "sign2text_concat_s")
def sign2text_concat_s(args):
    args.encoder_layers = getattr(args, "encoder_layers", 3)
...
@register_model_architecture("sign2text_concat", "sign2text_concat_s_relative")
def sign2text_concat_s_relative(args):
    args.max_encoder_relative_length = 100
    args.k_only = True
    sign2text_concat_s(args)


@register_model_architecture("sign2text_concat", "sign2text_concat_xs")
def sign2text_concat_xs(args):
...
@register_model_architecture("sign2text_concat", "sign2text_concat_sp")
def sign2text_concat_sp(args):
    args.encoder_layers = getattr(args, "encoder_layers", 16)
    sign2text_concat_s(args)


@register_model_architecture("sign2text_concat", "sign2text_concat_m")
def sign2text_concat_m(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("sign2text_concat", "sign2text_concat_mp")
def sign2text_concat_mp(args):
    args.encoder_layers = getattr(args, "encoder_layers", 16)
    sign2text_concat_m(args)


@register_model_architecture("sign2text_concat", "sign2text_concat_l")
def sign2text_concat_l(args):
...
@register_model_architecture("sign2text_concat", "sign2text_concat_lp")
def sign2text_concat_lp(args):
    args.encoder_layers = getattr(args, "encoder_layers", 16)
    sign2text_concat_l(args)
